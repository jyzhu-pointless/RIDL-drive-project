...
def heatmap(src, xcol, ycol, zcol, xlabel, ylabel, title, cbarlabel, colormap, colormap_display):
    ...
    cbfig = plt.figure(figsize=(8.5,1.2))# 8.5,1.2 1.5,8.5
    ...
    save_and_display(fig, f"{src}_heatmap_convex.png")
    #save_and_display(cbfig, f"colorbar.png")
    save_and_display(cbfig, f"{src}_colorbar_glf_convex.png")
    plt.show()
...
def main():
    ...
    parser.add_argument('-x_label', '--X_LABEL', default="Drive efficiency", type=str, help="Label for the x axis.")#Low density growth rate
