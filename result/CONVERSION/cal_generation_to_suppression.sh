...
echo "drive_efficiency,drop_ratio,low_density_growth_rate,density_growth_curve,generation_to_suppression"
...
do
    ...
    # echo "drive_efficiency,drop_ratio,low_density_growth_rate,generation_to_suppression,density_growth_curve"
    # echo $density_growth_curve
    echo "$drive_efficiency,$drop_ratio,$low_density_growth_rate,$density_growth_curve,$generation"
