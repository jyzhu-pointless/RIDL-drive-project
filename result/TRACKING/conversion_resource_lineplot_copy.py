...
def lineplot(src, xcol, ycol, xlabel, ylabel, title, cbarlabel, trimmer):
    ...
    ax.set_yticks([i+0.5 for i in linspace(0, y5_dim-1, 6)])  # This line creates six ticks on the y axis which are centered on the row they correspond to.
    ...
    ax.legend(["0.00","0.25","0.50","0.75","1.00"],loc="right",title="Drive efficiency")
    ...
    save_and_display(fig, f"{src}_SIT_lineplot_freq.png")
...
def main():
    ...
    parser.add_argument('-y','--Y_COL', default=5, type=int, help="The column of the entries in Y.")
