...
def lineplot(src, xcol, ycol, xlabel, ylabel, title, cbarlabel, trimmer):
    ...
    ax.legend(["0.02","0.04","0.06","0.08","0.10"],loc="lower right",title="Migration rate",ncol=2)
    ...
    save_and_display(fig, f"{src}_female_size_100_lineplot.png")
...
def main():
    ...
    parser.add_argument('-y','--Y_COL', default=7, type=int, help="The column of the entries in Y.")
