...
def heatmap(src, xcol, ycol, zcol, xlabel, ylabel, title, cbarlabel, colormap, colormap_display):
    ...
    hm1 = ax.pcolormesh(plot_data, cmap = colormap_display, rasterized=True, vmin=100, vmax=300)
...
def main():
    ...
    parser.add_argument('-src', '--source', default="generations_to_drive_lost.csv", type=str, help="CSV file to make heatmap from.")
    ...
    parser.add_argument('-y_label', '--Y_LABEL', default="Migration rate", type=str, help="Label for the Y axis.")#Migration rate
    ...
    color_range_2 = Greys(linspace(0.5, 0.5, 1500))
