...
def heatmap(src, xcol, ycol, zcol, xlabel, ylabel, title, cbarlabel, colormap, colormap_display):
    ...
    cbfig = plt.figure(figsize=(1.6,8.5))# 8.5,1.2
...
def main():
    ...
    parser.add_argument('-src', '--source', default="generation_to_suppression_sorted.csv", type=str, help="CSV file to make heatmap from.")
