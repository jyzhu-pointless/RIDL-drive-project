...
echo "resistance_rate,drop_ratio,drive_efficiency,low_density_growth_rate,density_growth_curve,suppression_rate,type"
...
do
    ...
    drop_ratio=`echo $last_rows | cut -f 9 -d ',' | head -n 1`
